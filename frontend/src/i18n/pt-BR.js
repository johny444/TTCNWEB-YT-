const ptBR = {
  ...
  entities: {
    loan: {
      ...
      fields: {
        ...
        'issueDate': 'Ngày mượn',
        'dueDateRange': 'Ngày hết hạn mượn',
        'dueDate': 'Ngày hết hạn mượn',
  ...
  auth: {
    ...
    emailUnverified: {
      message: `Xác nhân email của bạn tại <strong>{0}</strong> để tiếp tực.`,
      submit: `Gửi lại xác nhận email`,
    },
    emptyPermissions: {
  ...
  roles: {
    owner: {
      label: 'Chủ',
      description: 'Truy cập tới mọi tài nguyên',
    },
    editor: {
      label: 'Người chỉnh sửa',
      description: 'Toàn quyền truy cập để chỉnh sửa mọi tài nguyên',
    },
    viewer: {
      label: 'Người xem',
      description: 'Truy cập để xem mọi tài nguyên',
    },
    auditLogViewer: {
      label: 'Xem lịch sử hoạt động',
      description: 'Truy cập để xem lịch sử hoạt động',
    },
    iamSecurityReviewer: {
      label: 'Người đánh giá bảo mật',
      description: `Toàn quyền truy cập để quản lý vai trò của người dùng`,
    },
    entityEditor: {
      label: 'Trình chỉnh sửa',
      description: 'Chỉnh sửa quyền truy cập vào tất cả các thực thể',
    },
    entityViewer: {
      label: 'Trình xem',
      description: 'Xem quyền truy cập vào tất cả các thực thể',
    },
    loanEditor: {
      label: 'Trình chỉnh sửa sách mượn',
      description: 'Chỉnh sửa truy cập vào sách mượn',
    },
    loanViewer: {
      label: 'Trình xem sách mượn',
      description: 'Xem truy cập vào sách mượn',
    },
    bookEditor: {
      label: 'Trình chỉnh sửa sách',
      description: 'Chỉnh sửa truy cập vào sách',
    },
    bookViewer: {
      label: 'Trình xem sách',
      description: 'Xem truy cập vào sách',
    },
  },
  ...
  user: {
    fields: {
      id: 'Id',
      authenticationUid: 'Xác thực Uid',
      avatars: 'Hình ảnh đại diện',
      email: 'Email',
      emails: 'Email(s)',
      fullName: 'Tên',
      firstName: 'Tên',
  ...
  auditLog: {
    ...
    entityNamesHint:
      'Ngăn cách các thực thể bằng dấu phẩy.',
    fields: {
      id: 'Id',
  ...
  errors: {
    ...
    404: 'Xin lỗi, trang bạn muons truy cập không tồn tại',
    ...
    defaultErrorMessage: 'Ops, xả ra lỗi',
  },
